...
public class PrimitiveArchTest extends OpenFastTestCase {
	...
	public void testAsciiEncode() {
	 ...
	 public void testByteVectorEncode() {
	        ...
	        System.out.println(ByteUtil.convertByteArrayToBitString(res));
	        // 对于字符串"架构"，"架"的UTF8编码为:E69EB6，"构"的UTF8编码为:E69E84
	        // 一共需要6个字节，因此长度为6
	        assertEquals(
	                "10000110 11100110 10011110 10110110 11100110 10011110 10000100"，
	                res);
	        ...
	        assertEquals(
	                "10000111 11100110 10011110 10110110 11100110 10011110 10000100"，
	                res);
	        //字节向量长度为2，
