...
set CP=%OPENFAST_HOME%\${project.artifactId}-${project.version}.jar;%OPENFAST_HOME%\lib\commons-cli-1.1.jar;%OPENFAST_HOME%\lib\xstream-1.3.jar;%OPENFAST_HOME%\lib\xpp3_min-1.1.4c.jar
set MAIN=org.openfast.examples.producer.Main
